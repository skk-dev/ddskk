;;; skk-oasys.el -- SKK に OASYS 風入力環境を提供
...
;; Last Modified: $Date: 2000/11/11 03:23:44 $
...
;; このファイルは 富士通のワードプロセッサ OASYS 風のキー配列とそれを実現するた
;; めのルールを提供します。
