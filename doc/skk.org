...
#+SUBTITLE: This edition is for SKK version 16.2.50
...
# ##### しおり付き PDF #####
#+TEXINFO_HEADER: @iftex
#+TEXINFO_HEADER: @usedvipdfmx
#+TEXINFO_HEADER: @end iftex
...
#+FINDEX: convert-standard-filename
  + ~~/.skk~
    ...
    また、DDSKK にはこのファイルを自動的にバイトコンパイルする機能 [fn:bcomp] が
    あります。
...
[fn:bcomp] [[skk-init-file の自動コンパイル][skk-init-file の自動コンパイル]].
